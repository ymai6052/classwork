...
public class Runner {
    ...
    public static void main (String[] args)
    {
        ...
        System.out.println("Total Area: " + ShapeUtility.sumarea(shapeArr)); //168.26
        System.out.println("Total Perimeter: " + ShapeUtility.sumperimeter(shapeArr)); //86.84
        System.out.println("\nDid the three shapes above add up to the total printed here?\n");
        ...
        {
            shapeArr[i] = ShapeUtility.getRandomShape();
        }
        ...
        System.out.println("\nTotal Area: " + ShapeUtility.sumarea(shapeArr));
        System.out.println("Total Perimeter: " + ShapeUtility.sumperimeter(shapeArr));
